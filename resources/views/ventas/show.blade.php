        ...
        <table class="table">
            ...
            <div class="col-12 mb-5">
                <strong>Opciones:<strong>
                    <a href="{{ route('generaPdf',['id' => $ventas->idventas]) }}" class="btn btn-danger btn-sm">Exportar PDF</a>
                    <a onclick="window.print()" class="btn btn-primary btn-sm">Imprimir</a>
                    <a href="{{ route('ventas.index') }}" class="btn btn-success btn-sm">Volver atrás</a>
